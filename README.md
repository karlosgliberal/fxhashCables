# Este es un apaño para poder usar el export de cables y generar el zip para fx

Te haces un export del proyecto de cables y copias el patch.js en /src
Editas el index con las funciones y variables que necesites y con yarn run build generarar el zip que luego podrás subir a fxhash
